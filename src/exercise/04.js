...
function App() {
  ...
  // This ref will be used for the parentRef option you pass to useVirtual
  ...
  const rowVirtualizer = useVirtual({
    size: items.length,
    parentRef: listRef,
    // Memoize callback that returns the size of each item
    estimateSize: React.useCallback(() => 20, []),
    // Number of row to render in advance around the window
    overscan: 10,
  })
