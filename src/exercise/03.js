...
ListItem = React.memo(ListItem, (prevProps, nextProps) => {
  ...
  if (prevProps.highlightedIndex !== nextProps.highlightedIndex) {
    const hightlightedBefore = prevProps.index === prevProps.highlightedIndex
    const highlightedNext = nextProps.index === nextProps.highlightedIndex
    return hightlightedBefore === highlightedNext
  }
  return true
})
